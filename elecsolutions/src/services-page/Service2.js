...
import { AppBar, Toolbar, Typography, Avatar, Menu, MenuItem, Grid, Card, CardContent, Button } from '@mui/material';
...
>
  ...
  <span style={{ marginLeft: '5px' }}>2023 Elecsolutions</span>
      ...
      <Routes path="/product/:id" element={<ProductDetail />} />
    </div>
  );
};
